...
function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
    ...
    function deleteNotDigits(digit){
...
const getResource = async (url) => {
    ...
    if(!res.ok) {
        throw new Error(`Chould not fetch ${url}, status: ${res.status}`);
    }
...
window.addEventListener('DOMContentLoaded', () => {  
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2023-08-25');
